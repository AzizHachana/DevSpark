...
if (
    ...
    if (
        ...
        // Sanitize input and prepare data
        ...
        $event = new event($event_id, $nom, $place, $type, $date, $description, $prix);
    ...
    <form action="" method="POST">
        <table>
            <tr>
                ...
                <td>
                    <input type="text" id="id" name="event_id" value="<?php echo $_POST['event_id'] ?>" readonly />
