...
<body>
    ...
    <div class="col-md-12">
        <form method="GET" action="Blog2.php" class="form-inline justify-content-between">
            ...
            <div class="row d-flex">
                ...
                <div class="col-lg-4 d-flex ftco-animate">
                    <div class="blog-entry justify-content-end">
                        <a href="blog-single2.php?id=<?php echo $country['id'] ?>" class="block-20"
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between mb-2">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <a href="blog-single2.php?id=<?php echo $country['id'];?>" class="ml-2"><?php echo $country['NomP'];?></a>
                                        </div>
                                        <span class="remove-from-favorites" data-id="<?php echo $country['id'];?>">×</span>
                                    </div>
                                <?php endforeach;?>
                                <div class="text-center">
                                        <img src="../assets/img/Pays.png" alt="Country Placeholder Image" style="width: 350px; height: 220px;">
                                </div>
                                    </div>
...
$(document).ready(function() {
        ...
        <div class="block-27">
            <ul>
                <?php if ($page > 1) : ?>
                    ...
                    <li><a href="Blog2.php?page=<?php echo $page - 1; ?>">&lt;</a></li>
                <?php endif; ?>
                
                <!-- Affichage des numéros de page -->
                <?php for ($i = 1; $i <= $totalPages; $i++) : ?>
                    <li <?php if ($i == $page) echo 'class="active"'; ?>>
                        <a href="Blog2.php?page=<?php echo $i; ?>"><?php echo $i; ?></a>
                    </li>
                <?php endfor; ?>
    ...
    <a href="https://www.instagram.com/share/url=http://localhost/vacation/view/Blog2.php?page=1#" target="_blank">
      <div class="menuItems">
    ...
    <a href="https://twitter.com/intent/tweet?url=http://localhost/vacation/view/Blog2.php?page=1#" target="_blank">
      <div class="menuItems">
