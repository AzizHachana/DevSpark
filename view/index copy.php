...
<html lang="en">
  ...
  <body>
	     ...
	     <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#ftco-nav" aria-controls="ftco-nav" aria-expanded="false" aria-label="Toggle navigation">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          <li class="nav-item active"><a href="index copy.php" class="nav-link">Home</a></li>
                ...
                ?>
                    <div class="col-md-3 ftco-animate">
                        <div class="project-destination">
                            <a href="./blog-single2.php?id=<?php echo $pays['id'] ?>" class="img" style="background-image: url(../assets/img/uploads/<?php echo $pays['image']; ?>);">
                                <div class="text">
    ...
    <a href="https://www.instagram.com/share/url=http://localhost/vacation/view/index%20copy.php" target="_blank">
      <div class="menuItems">
    ...
    <a href="https://twitter.com/intent/tweet?url=http://localhost/vacation/view/index%20copy.php" target="_blank">
      <div class="menuItems">
...
chatbotId: "SwY7ZyTn8eByPenvoWm94",
