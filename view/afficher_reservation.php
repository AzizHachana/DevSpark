...
$query = "SELECT reservationh.*, hotel.Nom AS hotel_nom FROM reservationh
          INNER JOIN hotel ON reservationh.hotel_id = hotel.id
          WHERE reservationh.user_id = ?";
  $statement  = $pdo->prepare($query);
  $statement ->execute([$userId]);
$reservations =   $statement ->fetchAll();

$query = "SELECT hotel.Nom AS hotel_nom, COUNT(reservationh.id) AS reservation_count
          FROM reservationh
          INNER JOIN hotel ON reservationh.hotel_id = hotel.id
          WHERE reservationh.user_id = ?
          GROUP BY hotel.Nom
