	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
            ...
            <li class="nav-item "><a href="index copy.php" class="nav-link">Home</a></li>
	          <li class="nav-item active"><a href="eventFront2.php" class="nav-link">Destination</a></li>
  ...
  <div class="container">
    <div class="slider-text">
      <div class="col-md-9 ftco-animate pb-5 text-center">
        ...
        <p class="breadcrumbs"><span class="mr-2"><a href="index copy.php">Home <i class="ion-ios-arrow-forward"></i></a></span> <span>Destination <i class="ion-ios-arrow-forward"></i></span></p>
      </div>
    </div>
  </div>
                ...
                <div class="col-md-4 ftco-animate">
                    <div class="project-wrap">
                        ...
                        <div class="text p-4">
                            ...
                            <div class="buttons">
                                <button type="button" class="btn btn-primary"><a href="../view/review2.php?id_e=<?= $event['id']; ?>" style="color: white;">Review</a></button>
                                <button type="button" class="btn btn-primary"><a href="../view/addreservationE2.php?id_e=<?= $event['id']; ?>" style="color: white;">Voir Détails</a></button>
                            </div>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        document.querySelectorAll('.btn.btn-primary').forEach(function(btn) {
            btn.addEventListener('click', function(event) {
                ...
                reservationLink.href = `../view/addreservationE2.php?id=${eventID}`;
            });
        });
    });
</script>
