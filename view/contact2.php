	  ...
	  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
          ...
          <li class="nav-item "><a href="index copy.php" class="nav-link">Home</a></li>
              ...
              <li class="nav-item active "><a href="contact2.php" class="nav-link">Réclamations</a></li>
      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-center">
          <div class="col-md-9 ftco-animate pb-5 text-center">
            ...
            <p class="breadcrumbs"><span class="mr-2"><a href="index copy.php">Home <i class="ion-ios-arrow-forward"></i></a></span> <span>Contact us <i class="ion-ios-arrow-forward"></i></span></p>
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="container">
        <div class="row block-9">
          <div class="col-md-6 order-md-last d-flex">
            <form action="../../../model/CreateContact.php" method="GET" class="bg-light p-5 contact-form">
