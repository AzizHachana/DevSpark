...
$c = new unityuserU();
$tab = $c->listUnityusersB();

$query = "SELECT unityuser.etat AS client_etat, COUNT(*) AS total
        FROM unityuser
        GROUP BY unityuser.etat";
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent  bg-primary  navbar-absolute">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="#pablo">Liste Des Comptes Bloqués</a>
          </div>
          ...
          <div class="col-md-12">
            <div class="card">
              <table class="table">
                <thead>
                  <tr>
                    <h5 class="card-category">Comptes Bloqués</h5>
...
<tbody>
    ...
    <?php foreach ($tab as $unityuser) { ?>
        <tr>
            ...
            <td>
                <a href="../view/editUser.php?id=<?= $unityuser['id']; ?>">Debloquer</a>
...
<script>
  ...
  <script>
    ...
    const clientData = {
        labels: <?php echo json_encode(array_column($client_stats, 'client_etat')) ?>,
        datasets: [{
            label: 'Statistiques selon l état ',
                ...
                tooltip: {
                    callbacks: {
                        label: function(context) {
                            ...
                            const percentage = context.raw / context.chart.data.datasets[0].data.reduce((a, b) => a + b) * 100;
