        ...
        <div class="container">
            <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-center">
                <div class="col-md-9 ftco-animate pb-5 text-center">
                    ...
                    <p class="breadcrumbs"><span class="mr-2"><a href="index copy.php">Home <i class="ion-ios-arrow-forward"></i></a></span> <span class="mr-2"><a href="Blog2.php">Blog <i class="ion-ios-arrow-forward"></i></a></span>
                        <span>
                ...
                <div class="desc">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="row">
                                <div class="col-md-12">
                                    <p style="font-size: 25px; margin-bottom: 10px;"><strong>- Capitale :</strong>
                                        <?php echo $Description['Capitale']; ?></p>
                                </div>
                                <div class="col-md-12">
                                    <p style="font-size: 25px; margin-bottom: 10px;"><strong>- Climat :</strong>
                                        <?php echo $Description['Climat']; ?></p>
                                </div>
                                <div class="col-md-12">
                                    <p style="font-size: 25px; margin-bottom: 10px;"><strong>- Langue :</strong>
                                        <?php echo $Description['Langue']; ?></p>
                                </div>
                                <div class="col-md-12">
                                    <p style="font-size: 25px; margin-bottom: 10px;"><strong>- Monnaie :</strong>
                                        <?php echo $Description['Monnaie']; ?></p>
                                </div>
                                <div class="col-md-12">
                                    <p style="font-size: 25px; margin-bottom: 10px;"><strong>- Attractions Touristiques
                                            :</strong> <?php echo $Description['Attractions_touristiques']; ?></p>
                                </div>
                                <div class="col-md-12">
                                    <p style="font-size: 25px; margin-bottom: 10px;"><strong>- Activites :</strong>
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            if (response === "You have already liked this comment.") {
                                alert(
                                    response
                                ); // Affichage du message si l'utilisateur a déjà aimé
                            } else {
                    ...
                    <div class="ftco-footer-widget mb-4">
                        ...
                        <div class="box">
                            ...
                            <div class="menu">
                                ...
                                <a href="https://www.instagram.com/share/url=http://localhost/vacation/view/blog-single2.php?id=<?php echo $Pays['id'] ?>" target="_blank">
                                    <div class="menuItems">
                                ...
                                <a href="https://twitter.com/intent/tweet?url=http://localhost/vacation/view/blog-single2.php?id=<?php echo $Pays['id'] ?>" target="_blank">
                                    <div class="menuItems">
