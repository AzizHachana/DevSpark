...
$(document).ready(function() {
    ...
    <a href="https://www.instagram.com/share/url=http://localhost/vacation/view/Blog.php?page=1#" target="_blank">
      <div class="menuItems">
    ...
    <a href="https://twitter.com/intent/tweet?url=http://localhost/vacation/view/Blog.php?page=1#" target="_blank">
      <div class="menuItems">
