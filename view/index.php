        ...
        <div class="container">
            <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center" data-scrollax-parent="true">
                <div class="col-md-9 text text-center ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
                    ...
                    <h1 data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">Explorez le monde avec nous !
                    </h1>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-md-4 ftco-animate">
                    <div class="project-wrap">
                        <a href="#" class="img" style="background-image: url(../assets/img/destination-1.jpg);"></a>
                        <div class="text p-4">
                ...
                <div class="col-md-4 ftco-animate">
                    <div class="project-wrap">
                        <a href="#" class="img" style="background-image: url(../assets/img/destination-2.jpg);"></a>
                        <div class="text p-4">
                            <span class="price">$300/person</span>
                ...
                <div class="col-md-4 ftco-animate">
                    <div class="project-wrap">
                        <a href="#" class="img" style="background-image: url(../assets/img/destination-3.jpg);"></a>
                        <div class="text p-4">
                            <span class="price">$300/person</span>
