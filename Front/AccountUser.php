...
if (!isset($_SESSION['id'])) {
    ...
    header('Location: /vacation/Admin/pages/samples/login.php');
...
<head>
    ...
    <style>
        /* Change active list item color to orange */
        .list-group-item.active {
            background-color: orange !important;
            color: white !important;
        }

        /* Change the Save button color to orange */
        .donate_btn a {
...
<body>
    ...
    <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item">
            <a class="nav-link" href="../view/contact.php">Réclamations</a>
        </li>
        <li class="nav-item">
            ...
            <div class="row no-gutters row-bordered row-border-light">
                <div class="col-md-3 pt-0">
                    <div class="list-group list-group-flush account-settings-links">
                        ...
                        <a class="list-group-item list-group-item-action" href="/vacation/Front/AccountUsermdp.php#account-change-password">Change password</a>
                        <a class="list-group-item list-group-item-action" data-toggle="list" href="#account-info">Info</a>
                        <a class="list-group-item list-group-item-action" data-toggle="list" href="#account-social-links">Social links</a>
                        <a class="list-group-item list-group-item-action" href="#account-connections">Historic Command</a>
                ...
                <div class="col-md-9">
                    <div class="tab-content">
                        <div class="tab-pane fade active show" id="account-general">
                            ...
                            <div class="card-body">
                                <?php 
                                    include $_SERVER["DOCUMENT_ROOT"] . "/vacation/view/updateUnityuser.php";
                                ?>
                            </div>
                        </div>
                        <div class="tab-pane fade" id="account-change-password">
                            <div class="card-body pb-2">
                                <?php 
                                    //include $_SERVER["DOCUMENT_ROOT"] . "/vacation/view/updatemdp.php";
                                ?>
                            </div>
                        </div>
                        ...
                        <div class="tab-pane fade" id="account-connections">
                            <hr class="border-light m-0">
                                <!--#####################################################################-->
                                    <?php   //include_once($_SERVER['DOCUMENT_ROOT'] . '/vacation/View/afficherCommande.php'); ?>
                                <!--#####################################################################-->     
                        </div>
