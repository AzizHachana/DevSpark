...
<body>
   ...
   <div class="donate_section layout_padding margin_1">
      <div class="gallery_section layout_padding">
         <div class="container">
            <h1 class="banner_taital">Best Product</h1>
            ...
            <div class="gallery_section_2 layout_padding">
               <div class="row">
               <!--#####################################################################-->
               <?php   include_once($_SERVER['DOCUMENT_ROOT'] . '/vacation/View/ajouterAuPanier.php'); ?>
                <!--#####################################################################-->               </div>
            </div>
         </div>
      </div>
