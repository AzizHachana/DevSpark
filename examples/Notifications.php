    ...
    <div class="notifications" style="margin-top: 20px;">
        ...
        <?php $counter = 0; foreach ($newCommentsNotifications as $notification) :?>
            <div class="notification-item" id="notification-<?php echo $counter;?>">
                ...
                <p class="notification-title">- Nouveau commentaire de <strong><?php echo ucfirst(strtolower($notification['nom'])). ' '. ucfirst(strtolower($notification['prenom']));?></strong> sur le Blog <strong><?php echo ucfirst(strtolower($notification['NomP']));?></strong></p>
