        ...
        <div class="content">
            ...
            <tbody>
                <?php foreach($reclams as $reclam): ?>
                    <tr>                      
                        <td><?php echo $reclam['sujet']; ?></td>
                        <td><?php echo $reclam['description']; ?></td>
                        <td><?php echo $reclam['date_reclamation']; ?></td>
                        <td>
                          
                        <button onclick="openModal('<?php echo $reclam['id_reclamation']; ?>')" class="btn btn-primary">
                        <i class="fas fa-edit"></i>
                    </button>
                            <!-- Form for updating collaboration -->
                          
                            <div id="myModal_<?php echo $reclam['id_reclamation']; ?>" class="modal" style="display: none;">
                                <div class="modal-content">
                                    <span class="close" onclick="closeModal('<?php echo $reclam['id_reclamation']; ?>')">&times;</span>
                                    <form action="" method="POST">
                                        <input type="hidden" name="id_reclamation" value="<?php echo $reclam['id_reclamation']; ?>">
                                        <label for="sujet">sujet</label>
                                        <input type="text" name="sujet" value="<?php echo $reclam['sujet']; ?>"><br>
                                        <label for="description">Description:</label>
                                        <textarea name="description" rows="4" cols="50"><?php echo $reclam['description']; ?></textarea><br>
                                        <label for="date_reclamation">date </label>
                                        <input type="date" name="date_reclamation" value="<?php echo $reclam['date_reclamation']; ?>"><br>
